                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 20px; color: #5b5b5b; font-size: 14px;">
                                                ...
                                                {{ env('BRAND_NAME', 'Origin CMS') }}.<br />
                                                Please follow the link below to verify your email address<br /><br />
                                                <div style="text-align: center;">
                                                    <a href="{{ route('verify.email', $data['email_confirmation_code']) }}" style="text-decoration: none; color: #FFF; background-color: #1ab394; border: solid #1ab394; border-width: 5px 10px; line-height: 2; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize;">
