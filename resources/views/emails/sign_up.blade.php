...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Registration - {{ env('BRAND_NAME', 'Origin CMS') }}</title>
    </head>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 20px; color: #5b5b5b; font-size: 14px;">
                                                ...
                                                <div style="text-align: center;">
                                                    <a href="{{ route('login') }}" style="text-decoration: none; color: #FFF; background-color: #1ab394; border: solid #1ab394; border-width: 5px 10px; line-height: 2; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize;">
                                                        Login
                                                    </a>
                                                </div><br />
                                                See you soon.
