...
class SettingsSeeder extends Seeder
{
    ...
    {
        $settings = array(
            ['field_name' => 'email', 'field_value' => 'Active', 'module' => 'Email', 'owner' => 'sysadmin', 'last_updated_by' => 'sysadmin', 'created_at' => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")],
            ['field_name' => 'sms', 'field_value' => 'Active', 'module' => 'SMS', 'owner' => 'sysadmin', 'last_updated_by' => 'sysadmin', 'created_at' => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")],
